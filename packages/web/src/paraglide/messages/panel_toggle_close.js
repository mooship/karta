...
*/
export const panel_toggle_close = /** @type {((inputs?: Panel_Toggle_CloseInputs, options?: { locale?: "en" | "st" | "zu" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Panel_Toggle_CloseInputs, { locale?: "en" | "st" | "zu" }, {}>} */ ((inputs = {}, options = {}) => {
