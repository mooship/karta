...
*/
export const bucket_car_time_moderate = /** @type {((inputs?: Bucket_Car_Time_ModerateInputs, options?: { locale?: "en" | "st" | "zu" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Bucket_Car_Time_ModerateInputs, { locale?: "en" | "st" | "zu" }, {}>} */ ((inputs = {}, options = {}) => {
