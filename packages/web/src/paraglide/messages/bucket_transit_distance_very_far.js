...
*/
export const bucket_transit_distance_very_far = /** @type {((inputs?: Bucket_Transit_Distance_Very_FarInputs, options?: { locale?: "en" | "st" | "zu" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Bucket_Transit_Distance_Very_FarInputs, { locale?: "en" | "st" | "zu" }, {}>} */ ((inputs = {}, options = {}) => {
