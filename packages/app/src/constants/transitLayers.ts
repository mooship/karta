 ...
 * rebuild helper, see `pnpm run display` in `data-pipeline/README.md`) knows
 ...
 *   `"prasa"`) from the current shipped `spatial-apartheid-legacy` layer ids
 *   (`rapid-rail`, `bus-rapid-transit`, `commuter-rail`, `bus`, defined in
 *   `domains/spatial-apartheid-legacy/layers.ts`), which group multiple
